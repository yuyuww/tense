...
#현재문장 baseline T/F 비율과 3연쇄용 next T/F 비율만 계산합니다. 두 번째 파일의 baseline 함수입니다.
...
#analyze_unit_sequence_effect: unit별 1·2·3연쇄를 계산하되, 2연쇄 기대값을 unit의 prev 분포 × unit의 curr 분포로 둡니다. 연쇄효과만 보려는 목적에 가장 잘 맞는 버전입니다.
